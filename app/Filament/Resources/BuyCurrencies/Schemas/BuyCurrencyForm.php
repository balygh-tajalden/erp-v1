                        ...
                        Grid::make(3)
                            ->schema([
                                TextInput::make('Thenumber')
                                    ...
                                    ->required()
                                    ->columnStart([1])
                                    ->default(fn($get) => BuyCurrencyResource::getDefaultDocumentNumber($get)),

                                Select::make('BranchID')
                                    ->label('الفرع')
                                    ->options(BuyCurrencyResource::getBranchOptions())
                                    ->required()
                                    ->live()
                                    ->default(2)
                                    ->afterStateUpdated(fn($set, $get) => BuyCurrencyResource::refreshDocumentNumber($set, $get, 'Thenumber')),
                                ...
                                Select::make('AccountID')
                                    ...
                                    ->options(
                                        fn($get): array => $get('PurchaseMethod') === 1
                                            ? BuyCurrencyResource::getCashBoxOptions()
                                            : BuyCurrencyResource::getChildrenAccountOptions()
                                    ),
                                ...
                                Select::make('CurrencyID')
                                    ...
                                    ->required()
                                    ->live()
                                    ->afterStateUpdated(fn($get, $set) => BuyCurrencyResource::refreshCurrencyPrice('buy', $get, $set))
                                    ->options(
                                        collect(BuyCurrencyResource::getCurrencyOptions())
                                ...
                                Select::make('ExchangeCurrencyID')
                                    ...
                                    ->live()
                                    ->afterStateUpdated(fn($get, $set) => BuyCurrencyResource::refreshCurrencyPrice('buy', $get, $set))
                                    ->options(BuyCurrencyResource::getCurrencyOptions()),
                                ...
                                TextInput::make('Amount')
                                    ...
                                    ->required()
                                    ->lazy()
                                    ->afterStateUpdated(fn($get, $set) => BuyCurrencyResource::refreshExchangeAmount($get, $set)),
